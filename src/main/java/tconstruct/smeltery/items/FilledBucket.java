...
public class FilledBucket extends ItemBucket {
    ...
    public static final String[] materialNames = new String[] { "Iron", "Gold", "Copper", "Tin", "Aluminum", "Cobalt",
            ...
            "Cow", "Nickel", "Lead", "Silver", "Shiny", "Invar", "Constantan", "Electrum", "Ender", "Slime", "Glue",
            "PigIron", "Lumium", "Signalum", "Mithril", "Enderium", "Quartz", "Manasteel", "Terrasteel", "Elementium",
            "Thaumium" };
    ...
    public static final String[] textureNames = new String[] { "iron", "gold", "copper", "tin", "aluminum", "cobalt",
            ...
            "blood", "nickel", "lead", "silver", "shiny", "invar", "constantan", "electrum", "ender", "slime", "glue",
            "pigiron", "lumium", "signalum", "mithril", "enderium", "quartz", "manasteel", "terrasteel", "elementium",
            "thaumium" };
}
